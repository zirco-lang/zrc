...
```
as          asm         break       continue    default     do
...
### 6.7 Module-Level Assembly

Module-level assembly allows adding raw assembly directives to the compiled module.

**Syntax**: `asm "assembly_code";`

**Example**:
```zirco
// Add a comment to the generated assembly
...
**Rules**:
- Assembly code must be provided as a string literal
- Module-level assembly is added directly to the output assembly file
- Useful for adding metadata, custom sections, or assembly-level directives
- The assembly syntax follows the target platform's assembler conventions

**Common Uses**:
- Adding assembly comments or metadata
