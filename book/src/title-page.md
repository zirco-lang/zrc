...
_The Zirco Programming Language_ is an introduction and reference for the programming language
Zirco, which helps you write clean, expressive code while maintaining explicitness, control, and
compatibility with existing systems languages.
